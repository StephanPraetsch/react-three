...
import {Group, Material, Mesh, PerspectiveCamera, Scene, Vector3, WebGLRenderer} from 'three';
...
function render(refContainer: any) {
    ...
    let camera: PerspectiveCamera, cameraTarget: Vector3, scene: Scene, renderer: WebGLRenderer;

    let group: Group, textMesh1: Mesh, textMesh2: Mesh, textGeo: TextGeometry, materials: Material[];
    ...
    function loadFont() {
        ...
        // TODO doesn't work, miss font files => is this statically possible?
